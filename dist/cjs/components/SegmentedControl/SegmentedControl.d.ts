 ...
 */
export declare const SegmentedControl: ({ size, name, options, getRootRef, onChange, value: valueProp, defaultValue, children, dataTest, ...restProps }: SegmentedControlProps) => JSX.Element;
